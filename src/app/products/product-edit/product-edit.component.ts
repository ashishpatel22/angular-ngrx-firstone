...
export class ProductEditComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder,
              private productService: ProductService, private store: Store<fromProduct.ProductState>) {
  ...
  ngOnInit(): void {
    ...
    /*is.sub = this.productService.selectedProductChanges$.subscribe(
    ...
    this.store.pipe(select(fromProduct.getCurrentProduct)).subscribe(
      currentPoduct => {
        console.log("product edit omponent triggered with : " + JSON.stringify(currentPoduct));
        this.displayProduct(currentPoduct)
      }
    );
  }
